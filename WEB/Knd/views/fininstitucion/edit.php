...
<head>
    ...
    <title>PlusvaliaBlk - Editar Institución Financiera</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Editar Institución Financiera</h1>
                    <form action="index.php?controller=fininstitucion&action=edit&id=<?php echo $institucion['fin_id']; ?>" method="post">
                        <div class="form-group">
                            <label for="fin_nombre">Nombre de la Institución:</label>
                            <input type="text" id="fin_nombre" name="fin_nombre" class="form-control" value="<?php echo htmlspecialchars($institucion['fin_nombre']); ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="fin_tasa_interes">Tasa de Interés (%):</label>
                            <input type="number" id="fin_tasa_interes" name="fin_tasa_interes" class="form-control"
                                value="<?php echo htmlspecialchars($institucion['fin_tasa_interes']); ?>" step="0.01" min="0" required>
                        </div>

                        <div class="form-group">
                            <label for="fin_terminos">Términos y Condiciones:</label>
                            <textarea id="fin_terminos" name="fin_terminos" class="form-control" rows="4" required><?php echo htmlspecialchars($institucion['fin_terminos']); ?></textarea>
                        </div>
                        <div class="form-group">
                            <input type="submit" value="Actualizar Institución" class="btn btn-primary">
                        ...
                        <script>
                            document.addEventListener("DOMContentLoaded", function() {
                                Swal.fire({
                                    ...
                                    text: '<?= $success ? "✅ Institución actualizada exitosamente." : "❌ Hubo un error al actualizar la institución. Inténtalo de nuevo." ?>',
