...
<head>
    ...
    <title>PlusvaliaBlk - Crear Rol</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="index.php?controller=rol&action=create" method="post">
                        ...
                        <script>
                            document.addEventListener("DOMContentLoaded", function() {
                                Swal.fire({
                                    ...
                                    text: '<?= $success ? "✅ Rol creado exitosamente." : "❌ Hubo un error al crear el rol. Inténtalo de nuevo." ?>',
