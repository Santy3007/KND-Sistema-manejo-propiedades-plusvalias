...
<head>
    ...
    <title>PlusvaliaBlk - Gestión de Roles</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <a href="index.php?controller=rol&action=create" class="btn btn-primary mb-3">Crear Nuevo Rol</a>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($rol['rol_status']); ?></td>
                                <td>
                                    <a href="index.php?controller=rol&action=edit&id=<?php echo $rol['rol_id']; ?>" class="btn btn-warning">Editar</a>
                                    <a href="javascript:void(0);" class="btn btn-danger btn-delete" data-id="<?php echo $rol['rol_id']; ?>">Eliminar</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                            ...
                            button.addEventListener('click', function () {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href = `index.php?controller=rol&action=delete&id=${rolId}`;
                                    }
                                });
                            });
                        });
