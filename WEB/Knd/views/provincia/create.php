...
<head>
    ...
    <title>PlusvaliaBlk - Crear Provincia</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Crear Nueva Provincia</h1>
                    <form action="index.php?controller=provincia&action=create" method="POST">
                        <div class="form-group">
                            <label for="provincia_nombre">Nombre de la Provincia:</label>
                            <input type="text" name="provincia_nombre" class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <script>
                            document.addEventListener("DOMContentLoaded", function() {
                                Swal.fire({
                                    ...
                                    text: '<?= $success ? "✅ Provincia creada exitosamente." : "❌ Hubo un error al crear la provincia." ?>',
