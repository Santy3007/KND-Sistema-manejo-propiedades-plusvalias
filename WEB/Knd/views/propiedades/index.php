...
<head>
    ...
    <title>PlusvaliaBlk - Listado de Propiedades</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <a href="index.php?controller=propiedad&action=create" class="btn btn-primary mb-3">Crear Nueva Propiedad</a>
                        ...
                        <tbody>
                            <?php foreach ($propiedades as $propiedad): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?controller=propiedad&action=show&id=<?php echo $propiedad['pro_id']; ?>" class="btn btn-info">Ver</a>
                                        <a href="index.php?controller=propiedad&action=edit&id=<?php echo $propiedad['pro_id']; ?>" class="btn btn-warning">Editar</a>
                            ...
                            button.addEventListener('click', function () {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href = `index.php?controller=propiedad&action=delete&id=${propiedadId}`;
                                    }
                                });
                            });
                        });
