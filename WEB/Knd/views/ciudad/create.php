...
<head>
    ...
    <title>PlusvaliaBlk - Crear Ciudad</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Crear Nueva Ciudad</h1>
                    <form action="index.php?controller=ciudad&action=create" method="POST">
                        <div class="form-group">
                            <label for="ciudad_nombre">Nombre de la Ciudad:</label>
                            <input type="text" name="ciudad_nombre" class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <script>
                            document.addEventListener("DOMContentLoaded", function() {
                                Swal.fire({
                                    ...
                                    text: "<?= $success ? '✅ Ciudad creada exitosamente.' : '❌ Hubo un error al crear la ciudad.'; ?>",
