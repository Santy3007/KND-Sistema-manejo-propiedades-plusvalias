        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <form action="index.php?controller=perfil&action=edit&id=<?php echo $perfil['per_id']; ?>" method="post">
                        <div class="form-group">
                            <label for="per_nombre">Nombre:</label>
                            <input type="text" id="per_nombre" name="per_nombre" class="form-control" value="<?php echo $perfil['per_nombre']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="per_apellido">Apellido:</label>
                            <input type="text" id="per_apellido" name="per_apellido" class="form-control" value="<?php echo $perfil['per_apellido']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="per_email">Email:</label>
                            <input type="email" id="per_email" name="per_email" class="form-control" value="<?php echo $perfil['per_email']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="per_password">Contraseña:</label>
                            <input type="password" id="per_password" name="per_password" class="form-control" value="<?php echo $perfil['per_password']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="rol_id">Rol:</label>
                            <select id="rol_id" name="rol_id" class="form-control" required>
                                <?php foreach ($roles as $rol): ?>
                                    <option value="<?php echo $rol['rol_id']; ?>" <?php echo $rol['rol_id'] == $perfil['rol_id'] ? 'selected' : ''; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select id="per_status" name="per_status" class="form-control" required>
                                <option value="A" <?php echo $perfil['per_status'] == 'A' ? 'selected' : ''; ?>>Activo</option>
                                <option value="I" <?php echo $perfil['per_status'] == 'I' ? 'selected' : ''; ?>>Inactivo</option>
                                <option value="P" <?php echo $perfil['per_status'] == 'P' ? 'selected' : ''; ?>>Pendiente</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        document.addEventListener("DOMContentLoaded", function() {
                            <?php if (isset($success) && $_SERVER['REQUEST_METHOD'] === 'POST'): ?>
                                Swal.fire({
                                    ...
                                    text: '<?= $success ? "✅ Perfil actualizado exitosamente." : "❌ Hubo un error al actualizar el perfil. Inténtalo de nuevo." ?>',
