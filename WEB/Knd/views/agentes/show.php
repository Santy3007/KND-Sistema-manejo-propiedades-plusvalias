...
// Si el usuario NO es admin (rol_id != 1) y no es el creador de la propiedad, no puede verla
if ($_SESSION['rol_id'] != 1 && $propiedad['per_id'] != $_SESSION['user_id']) {
    echo "No tienes permiso para ver esta propiedad.";
    exit();
}
                ...
                <div class="container-fluid">
                    ...
                    <div id="imageGallery">
                        ...
                        foreach ($imagenes as $imagen): ?>
                            <img src="<?php echo 'http://localhost/knd/uploads/' . basename($imagen); ?>" 
                                 alt="Imagen Propiedad" width="150" height="150" 
                                 style="object-fit: cover; margin-right: 10px;">
                        <?php endforeach; ?>                        
                    </div>
                    <h2>Plano del Proyecto</h2>
                    <?php if (!empty($propiedad['pro_planos'])): ?>
                        <iframe src="<?php echo 'http://localhost/knd/uploads/' . basename($propiedad['pro_planos']); ?>" 
                                width="600" height="400">
                        </iframe>
                    <?php endif; ?>

                </div>
                <a href="http://localhost/knd/views/agentes/index.php" class="btn btn-secondary mt-3">Volver al listado</a>
            </div>
        </div>
    </div>
