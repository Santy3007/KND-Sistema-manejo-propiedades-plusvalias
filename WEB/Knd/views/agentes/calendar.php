    ...
    if (!in_array($_SESSION['rol_id'], [1, 20 , 2])) {
    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active"><a class="nav-link" href="http://localhost/knd/views/agentes/calendar.php"><i class="fas fa-calendar-alt"></i><span>Calendario de Citas</span></a></li>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-flex justify-content-end mb-3">
                            <a href="seleccionar_cita.php" class="btn btn-primary">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    fetch('../../index.php?controller=cita&action=getEvents')
                    ...
                    eventClick: function(info) {
                        ...
                        fetch(`../../index.php?controller=cita&action=getById&id=${eventId}`)
                            .then(response => response.json())
                            .then(data => {
                                if (data) {
                ...
                document.getElementById('saveCitaBtn').addEventListener('click', function() {
                    ...
                    fetch(`../../index.php?controller=cita&action=${action}${citaId ? '&id=' + citaId : ''}`, {
                        method: 'POST',
                        body: formData
                    })
                    .then(response => response.json())
                ...
                document.getElementById('deleteCitaBtn').addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            fetch(`../../index.php?controller=cita&action=delete&id=${citaId}`)
                                .then(response => response.json())
                                .then(data => {
                                    if (data.success) {
